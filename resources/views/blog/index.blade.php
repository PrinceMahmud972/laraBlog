...
<div class="sm:grid grid-cols-2 gap-20 w-4/5 mx-auto py-15 border-b border-gray-200">
    ...
    <div>
        ...
        <p class="text-xl text-gray-700 pt-8 pb-10 leading-8 font-italic">
            {{$post->description}}
        </p>
        <a href="/blog/{{ $post->slug }}"
            class="uppercase bg-blue-500 text-gray-100 font-extrabold py-4 px-8 rounded-3xl">Keep Reading</a>
